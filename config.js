...
global.pairingNumber = process.env.BOT_NUMBER || '233538591345' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || '0i1ghQLZ#T-rvr_bYZLUOMaV0aNQrZjJ1AhUyO-m4rxRFRS-sGuE' ;  // put your session id here
